...
export function readShellElements(document = globalThis.document) {
  return {
    ...
    _geolibreOpenBtn: document.getElementById('geolibre-open-btn'),
    _geolibreBridgeStatus: document.getElementById('geolibre-bridge-status'),
    _geolibrePanel: document.getElementById('geolibre-panel'),
    _geolibrePanelStatus: document.getElementById('geolibre-panel-status'),
    _geolibreEventsFrame: document.getElementById('geolibre-events-frame'),
    _geolibreRefreshBtn: document.getElementById('geolibre-refresh-btn'),
    _geolibreExternalLink: document.getElementById('geolibre-open-external'),
